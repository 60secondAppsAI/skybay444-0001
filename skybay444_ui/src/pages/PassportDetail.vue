					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updatePassport()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Passports = true">Add</base-button>
								              <modal :show.sync="modal2Passports">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Passport Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="PassportId" type="text" placeholder="Enter PassportId" v-model="passportDetails.passportId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Number</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Number" type="text" placeholder="Enter Number" v-model="passportDetails.number"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Country</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Country" type="text" placeholder="Enter Country" v-model="passportDetails.country"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Expiration Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="passportDetails.expirationDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updatePassport() {
      ...
      const jsonData = JSON.stringify(this.passportDetails);
      const res = await PassportService.update(jsonData);
...
//        this.getAllPassports();
    ...
    async getPassportDetails() {
      try {
			let response = await PassportService.get(this.passportId);
			this.passportDetails = response.data;
